    ...
    <Draggable>
      <div className="absolute z-50 right-60 top-24">
        <div className="p-2 border rounded-xl bg-white bg-opacity-25">
          <div className="flex flex-col md:flex-row gap-2 md:gap-0 justify-between px-2 mb-2">
            <div
          ...
          <div
            className={cn(
              "md:w-[20vw] bg-white h-[20vh] border rounded-xl p-4 leading-none text-xs text-black overflow-x-scroll",
              className
            )}
          >
            {children}
