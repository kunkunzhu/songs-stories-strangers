...
export default function Home() {
  return (
    <main>
      <div>
        <div className="py-4 px-2 md:border rounded-xl bg-white bg-opacity-0 md:bg-opacity-5">
          <Card className="bg-opacity-5">
            <div className="flex flex-col gap-8 justify-between">
              ...
              <div className="flex flex-col md:flex-row mx-auto w-4/5 h-10 md:w-5/6 gap-2 md:justify-between">
                <TapeLink
                  className="justify-center md:justify-end rounded-full md:rounded-r-none"
                  href="/send/step-one"
                  text="send"
                />
                <TapeLink
                  className="justify-center md:justify-start rounded-full md:rounded-l-none"
                  href="/receive"
                  text="receive"
                />
              </div>
